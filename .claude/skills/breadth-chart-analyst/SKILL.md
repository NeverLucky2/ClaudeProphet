...
```bash
python3 .claude/skills/breadth-chart-analyst/scripts/extract_chart_right_edge.py <image_path> --percent 25
```
...
```
View: .claude/skills/breadth-chart-analyst/assets/SP500_Breadth_Index_200MA_8MA.jpeg
View: .claude/skills/breadth-chart-analyst/assets/US_Stock_Market_Uptrend_Ratio.jpeg
```
...
```bash
python3 .claude/skills/breadth-chart-analyst/scripts/detect_uptrend_ratio.py <image_path> [--debug]
```
...
```
Read and use as template: .claude/skills/breadth-chart-analyst/assets/breadth_analysis_template.md
```
...
```bash
python3 .claude/skills/breadth-chart-analyst/scripts/fetch_breadth_csv.py        # Human-readable
python3 .claude/skills/breadth-chart-analyst/scripts/fetch_breadth_csv.py --json  # JSON output
```
