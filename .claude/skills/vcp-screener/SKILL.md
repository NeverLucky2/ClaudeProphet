...
python3 .claude/skills/vcp-screener/scripts/screen_vcp.py --output-dir .claude/skills/vcp-screener/scripts

# Custom universe
python3 .claude/skills/vcp-screener/scripts/screen_vcp.py --universe AAPL NVDA MSFT AMZN META --output-dir .claude/skills/vcp-screener/scripts

# Full S&P 500 (paid API tier)
python3 .claude/skills/vcp-screener/scripts/screen_vcp.py --full-sp500 --output-dir .claude/skills/vcp-screener/scripts
```
